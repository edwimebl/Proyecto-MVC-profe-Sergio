      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i><span>Página principal</span></a></li>
            <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Productos</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="?c=producto"><i class="fa fa-circle-o"></i> Lista de productos</a></li>
